...
import {
    CrimeDateRangeAccessor
} from './CrimeDateRangeAccessor';
...
import "./styles/CrimeDateRange.scss";


export class CrimeDateRange extends SearchkitComponent<any,any>  {
    accessor:CrimeDateRangeAccessor
    noArgs:boolean
    ...
    defineAccessor() {
        ...
        return new CrimeDateRangeAccessor(id,{
